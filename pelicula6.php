...
<header style="margin: 0px 0px 0px 0px;">
    ...
    <div style="display: flex; justify-content: flex-end; align-items: center;">
        <div class="div-pelicula" style="background-image: url(imagen/blue-lock-the-movie-episode-nagi-north-american-theatrical-poster.avif); position: relative; ">
            <p class="titulo" style="position: absolute;margin-left: 20px; bottom: 100px;">BLUE LOCK THE MOVIE -EPISODE NAGI-</p>
...
<div class="container" >
    <div class="div-sinopsis">
        ...
        <p style="font-weight: normal;">
            Actores:    Ricco Fajardo, Aaron Dismuke and Drew Breedlovey. 
            <br>
    ...
    <div class="div-sinopsis" >
        <h1>Sinopsis</h1>
        <p style="font-weight: normal;">
Jugadores de fútbol de secundaria de todo Japón se reúnen para un controvertido 
proyecto diseñado para crear el mejor y más egoísta delantero del mundo..       </p>
    </div>    
</div>
