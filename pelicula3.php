...
<header style="margin: 0px 0px 0px 0px;">
    ...
    <div style="display: flex; justify-content: flex-end; align-items: center;">
        <div class="div-pelicula" style="background-image: url(imagen/if.avif); position: relative; ">
            <p class="titulo" style="position: absolute;margin-left: 20px; bottom: 100px;">IF</p>
...
<div class="container" >
    <div class="div-sinopsis">
        ...
        <p style="font-weight: normal;">
            Actores:  Cailey Fleming, Ryan Reynolds, John Krasinski, Fiona Shaw, Alan Kim, and Liza Colón-Zayas
            <br>
    ...
    <div class="div-sinopsis" >
        <h1>Sinopsis</h1>
        <p style="font-weight: normal;">
       Una joven que pasa por una experiencia difícil 
       comienza a ver a los amigos imaginarios de todos que han quedado atrás a medida que sus amigos de la vida real han ido creciendo.
        </p>
    </div>    
</div>
