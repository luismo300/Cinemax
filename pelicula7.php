...
<header style="margin: 0px 0px 0px 0px;">
    ...
    <div style="display: flex; justify-content: flex-end; align-items: center;">
        <div class="div-pelicula" style="background-image: url(imagen/the-exo.jpg); position: relative; ">
            <p class="titulo" style="position: absolute;margin-left: 20px; bottom: 100px;">The Exocism-</p>
...
<div class="container" >
    <div class="div-sinopsis">
        ...
        <p style="font-weight: normal;">
            Actores:    Sam Worthington, Chloe Bailey, Adam Goldberg, Adrian Pasdar, and David Hyde Pierce.
            <br>
    ...
    <div class="div-sinopsis" >
        <h1>Sinopsis</h1>
        <p style="font-weight: normal;">
Un actor con problemas comienza a exhibir un comportamiento disruptivo mientras filma una película de terror. 
Su hija separada se pregunta si está volviendo a caer en sus adicciones pasadas o si hay algo más siniestro en juego.
	</p>
    </div>    
</div>
