...
<header style="margin: 0px 0px 0px 0px;">
    ...
    <div style="display: flex; justify-content: flex-end; align-items: center;">
        <div class="div-pelicula" style="background-image: url(imagen/kok.jpg); position: relative; ">
            <p class="titulo" style="position: absolute;margin-left: 20px; bottom: 100px;">Kinds of Kindness</p>
...
<div class="container" >
    <div class="div-sinopsis">
        ...
        <p style="font-weight: normal;">
            Actores:    Emma Stone, Jesse Plemons, Willem Dafoe, Margaret Qualley, Hong Chau, Joe Alwyn, Mamoudou Athie, and Hunter Schafer..
            <br>
    ...
    <div class="div-sinopsis" >
        <h1>Sinopsis</h1>
        <p style="font-weight: normal;">
Tres historias giran en torno a un hombre que intenta tomar el control de su propia vida, 
un policía cuya esposa parece una persona diferente y una mujer que busca a alguien con una habilidad especial.
	</p>
    </div>    
</div>
