...
<header style="margin: 0px 0px 0px 0px;">
    ...
    <div style="display: flex; justify-content: flex-end; align-items: center;">
        <div class="div-pelicula" style="background-image: url(imagen/bad-boys-4.jpg); position: relative; ">
            <p class="titulo" style="position: absolute;margin-left: 20px; bottom: 100px;">Bad Boys: Ride or Die</p>
...
<div class="container" >
    <div class="div-sinopsis">
        ...
        <p style="font-weight: normal;">
            Actores:   Will Smith and Martin Lawrence.
            <br>
    ...
    <div class="div-sinopsis" >
        <h1>Sinopsis</h1>
        <p style="font-weight: normal;">
Este verano, los Bad Boys favoritos del mundo regresan 
con su combinación icónica de acción al borde de tu asiento y comedia escandalosa, pero esta vez con un giro: los mejores de Miami ahora están huyendo.        </p>
    </div>    
</div>
