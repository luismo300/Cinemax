...
<header style="margin: 0px 0px 0px 0px;">
    ...
    <div style="display: flex; justify-content: flex-end; align-items: center;">
        <div class="div-pelicula" style="background-image: url(imagen/the-watchers.jpg.webp); position: relative; ">
            <p class="titulo" style="position: absolute;margin-left: 20px; bottom: 100px;">The Watchers-</p>
...
<div class="container" >
    <div class="div-sinopsis">
        ...
        <p style="font-weight: normal;">
            Actores:    Dakota Fanning, Georgina Campbell, Olwen Fouéré, and Oliver Finnegan.
            <br>
            <br>
    ...
    <div class="div-sinopsis" >
        <h1>Sinopsis</h1>
        <p style="font-weight: normal;">
Un artista de 28 años queda varado en un extenso bosque virgen en el oeste de Irlanda. 
Al encontrar refugio, sin saberlo, queda atrapada junto a tres extraños que son acechados por criaturas misteriosas todas las noches.	</p>
    </div>    
</div>
