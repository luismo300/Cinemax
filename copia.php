            ...
            <ul>
                ...
                <li>
                    ...
                    <div class="navegador_derecho">
                        ...
                        <div id="cuentaCerrada">
                            <a href="#" style="font-size: 20px;" onclick="showLoginForm()">Login</a>&nbsp;or&nbsp;
                            <a href="Registro.php" style="font-size: 20px;">Register</a>
                        </div>
...
<footer>
    ...
    <div style="background-color: black;  display: flex; justify-content: flex-end; align-items: center; padding-right: 25px;">
        ...
        <a href="#" onclick="logout()" style="display: inline-block; margin-top: 0;">Logout</a>
    </div>
