...
<header style="margin: 0px 0px 0px 0px;">
    ...
    <div style="display: flex; justify-content: flex-end; align-items: center;">
        <div class="div-pelicula" style="background-image: url(imagen/pelicula/pelicula1.jpg); position: relative;">
            <p class="titulo" style="position: absolute;margin-left: 20px; bottom: 120px;">INSIDE OUT 2</p>
...
<div class="container" >
    <div class="div-sinopsis">
        ...
        <p style="font-weight: normal;">
            Actores: Phyllis Smith, Lewis Black, Tony Hale, Amy Poehle
            <br>
            Director: esKelsey Man
        </p>
    </div>
    <div class="div-sinopsis" >
        <h1>Sinopsis</h1>
        <p style="font-weight: normal;">
        La película de Disney y Pixar INTENSA-MENTE 2 vuelve a sumergirse en la mente de la flamante adolescente Riley 
        justo cuando el cuartel general está sufriendo una repentina demolición para hacer sitio a algo totalmente inesperado: 
        ¡nuevas emociones! Alegría, Tristeza, Furia, Temor y Desagrado, que llevan mucho tiempo realizando una operación exitosa,
         no están seguros de cómo sentirse cuando aparecen Ansiedad, Envidia, Ennui y Vergüenza.
        </p>
    </div>    
</div>
