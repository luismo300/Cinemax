...
<header style="margin: 0px 0px 0px 0px;">
    ...
    <div style="display: flex; justify-content: flex-end; align-items: center;">
        <div class="div-pelicula" style="background-image: url(imagen/garfield.jpg); position: relative; ">
            <p class="titulo" style="position: absolute;margin-left: 20px; bottom: 100px;">THE GARFIELD MOVIE</p>
...
<div class="container" >
    <div class="div-sinopsis">
        ...
        <p style="font-weight: normal;">
            Actores: Chris Pratt, Samuel L. Jackson, Nicholas Hoult, 
            Cecily Strong, Harvey Guillén, Hannah Waddingham, Brett Goldstein, Bowen Yang y Ving Rames.
            <br>
    ...
    <div class="div-sinopsis" >
        <h1>Sinopsis</h1>
        <p style="font-weight: normal;">
       Después de un inesperado reencuentro con su padre perdido hace mucho tiempo, el gato callejero Vic, 
       Garfield se ve obligado a dejar atrás su cómoda vida con Harald. Junto con Vic y Odie, planea un loco robo.
        </p>
    </div>    
</div>
...
// Consulta actualizada para obtener solo sillas entre las filas 26 a 50
$query = "SELECT * FROM silla WHERE id_pelicula = '2'  ORDER BY fila, columna";
...
if ($resultado->num_rows > 0) {
    ...
    $fila_actual = 26; // La primera fila a mostrar es la fila 26
    $columna_actual = 1;
    ...
    while ($silla = $resultado->fetch_assoc()) {
        ...
        if ($columna_actual == 1) {
            ...
            echo "<td style='background-color: black; color: white;'> $columna_actual</td>";  // Mostrar el número de fila en la primera columna
        }
